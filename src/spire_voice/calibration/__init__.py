...
`spire_voice.config` for `CalibrationConfig`/`CameraConfig`, and `config.py`
...
`spire_voice.config` circular through this very module. A caller reaches
the runner directly: `from spire_voice.calibration.runner import

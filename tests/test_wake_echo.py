...
# The exact samples and measured ratios 260922-woc-PLAN.md names -- the
...
_WAKE_ONLY_SAMPLES = ["ace fire", "fire", "hey, spire", "a spire"]
_COMMAND_SAMPLES = ["stop", "turn on the lights", "fire the lights"]
...
def test_wake_phrase_followed_by_a_command_is_not_wake_only() -> None:
    ...
    assert is_wake_only("hey spire turn on the lights", _PHRASE) is False

...
This module imports nothing from `atlas_mcp.safety`, unlike `ha.py`. Weather
...
from atlas_mcp.open_meteo import OpenMeteoClient, UpstreamMalformedError, UpstreamUnreachableError
...
mcp_server = MCPServer("atlas-weather")
